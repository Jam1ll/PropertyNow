...
using PropertyNow.Core.Application.Features.Agents.Commands.ChangeStatus;
using PropertyNow.Core.Application.Features.Agents.Queries.GetAgentProperty;
using PropertyNow.Core.Application.Features.Agents.Queries.GetById;
using PropertyNow.Core.Application.Features.Agents.Queries.List;
