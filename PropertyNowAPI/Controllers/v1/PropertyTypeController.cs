...
using PropertyNow.Core.Application.Features.PropertyTypes.Commands.Delete;
using PropertyNow.Core.Application.Features.PropertyTypes.Commands.Update;
using PropertyNow.Core.Application.Features.PropertyTypes.Queries.GetById;
using PropertyNow.Core.Application.Features.PropertyTypes.Queries.List;
